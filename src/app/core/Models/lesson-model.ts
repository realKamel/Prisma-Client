...
export interface Lesson {
  ...
  expiredDate?: string;   
  imageUrl?: string;      // <-- Changed from iconSvg to imageUrl
  currency: string;
}
...
export const STATIC_LESSONS: Lesson[] = [
  {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1636466497217-26a8cbeaf0aa?q=80&w=600&auto=format&fit=crop'
  },
  {
  ...
  },
  {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1555664424-778a69022365?q=80&w=600&auto=format&fit=crop'
  },
  {
