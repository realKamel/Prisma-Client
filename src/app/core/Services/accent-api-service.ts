...
export class AccentApiService {
    ...
    return this.http.get<ApiResponse<AccentColorModel>>(`${environment.apiUrl}/preferences/accent`, {
      params: { teacherEmail: environment.teacherEmail },
    });
  }

  updateAccentColor(accentColor: AccentColor): Observable<ApiResponse<null>> {
    return this.http.put<ApiResponse<null>>(`${environment.apiUrl}/teacher/preferences/accent`, { accentColor });
  }
}
