...
export class LessonsPageComponent implements OnInit {
  ...
  protected readonly deleteTarget = signal<AssistantLessonDto | null>(null);
  protected readonly toast = signal<{ message: string; visible: boolean }>({
    message: '',
    visible: false,
  });
